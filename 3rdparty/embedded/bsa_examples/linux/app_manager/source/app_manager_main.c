...
enum
{
    ...
    APP_MGR_MENU_ENABLE_PRIVACY,
    APP_MGR_MENU_DISABLE_PRIVACY,
#endif
...
void app_mgr_display_main_menu(void)
{
    ...
    APP_INFO1("\t%d => Enable LE Privacy", APP_MGR_MENU_ENABLE_PRIVACY);
    APP_INFO1("\t%d => Disable LE Privacy", APP_MGR_MENU_DISABLE_PRIVACY);
#endif
...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        case APP_MGR_MENU_ENABLE_PRIVACY:
            app_dm_set_ble_local_privacy(TRUE);
            break;

        case APP_MGR_MENU_DISABLE_PRIVACY:
